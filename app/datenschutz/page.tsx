...
export const metadata: Metadata = {
  title: 'Datenschutz | IMIDIA',
  description: 'Datenschutzerklärung von IMIDIA Handel, Vertrieb und Service.',
};
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto prose prose-lg prose-cocoa">
            ...
            <p>
              Die Nutzung erfolgt zum Zwecke der Vertragserfüllung gegenüber unseren potenziellen und
              bestehenden Kunden (Art. 6 Abs. 1 lit. b DSGVO) und im Interesse einer sicheren,
            ...
            <p>
              ...
              die Datenspeicherung entfällt (z. B. nach abgeschlossener Bearbeitung Ihrer Anfrage).

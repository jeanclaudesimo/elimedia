...
import type { ContactInfo, NavItem, SocialLink } from '@/types';
      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            {/* Social Links - Platzhalter für spätere Ergänzung */}
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sand-300">
              <p>{contact.company}</p>
              <p>{contact.street}</p>
              <p>{contact.city}</p>
              <p>{contact.country}</p>
              {contact.vatId && <p className="text-sand-400 text-sm">{contact.vatId}</p>}
              <p className="pt-2">
                <a
          ...
          {/* Öffnungszeiten */}
          <div>
            <h4 className="text-white font-semibold mb-6">Erreichbarkeit</h4>
            ...
            <div className="flex gap-6">
              {legalLinks.map((link) => (
                <Link
                  key={link.id}
                  href={link.href}
                  className="text-sand-400 hover:text-white text-sm transition-colors"
                >
                  {link.label}
                </Link>
              ))}
